...
****    - Change FILENAME Statement for FACTDATA to correct FACTDATA month (e.g. FACTDATA_JUN2021.txt);
...
FILENAME FACTDATA "&PATH1.FACTDATA_JUN2021.txt";
...
* define the STATUS text file extract via FILENAME statement;
FILENAME DTpp "&PATH1.DTpp.txt";
DATA DTpp;
INFILE DTpp firstobs=2 dlm=',' dsd missover;
INPUT 
PP_AGG 		: $1.
PP_AGGT 	: $21.
PP 			: $2.
